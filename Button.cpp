...
namespace SDLFramework {
    ...
    Button::Button(float x, float y, float w, float h, const std::string& label, const std::string& fontPath, int fontSize, SDL_Color bgColor, const std::string& textureFile)
        ...
        mBackgroundTexture = new GLTexture(textureFile, false);  // Create texture with the provided file path
        ...
        mTextTexture = new GLTexture(label, fontPath, fontSize, { 255, 255, 255, 255 }, false);  // White text
