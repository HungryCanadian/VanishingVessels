...
namespace SDLFramework {
	...
	void GLGraphics::DrawTexture(GLTexture* glTex, SDL_Rect* srcRect, SDL_Rect* dstRect, float angle, SDL_RendererFlip flip) {
		float x = -1;
		float y = -1;
		float w = 1;
		float h = 1;
	...
	void GLGraphics::InitRenderData(Texture* texture, SDL_Rect* srcRect, float angle, float x, float y, float w, float h, GLuint quadVAO) {
